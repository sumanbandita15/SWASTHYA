  ...
  client/
    ...
    src/
      ...
      actions/
        ...
        index.js
      components/
        AddFitnessRoutine.css
        AddFitnessRoutine.js
        Category.css
        Category.js
      reducers/   
        auth.js
...
Inside client and server the project directories, you can run:
...
**This is not required for React** but many people find this feature convenient. You can read about the benefits of this approach [here](https://medium.com/seek-ui-engineering/block-element-modifying-your-javascript-components-d7f99fcab52b). 
## Post-Processing CSS
...
We can change `start` and `build` scripts to include the CSS preprocessor commands:
